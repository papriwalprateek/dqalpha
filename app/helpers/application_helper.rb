...
def webpages_read(a)
 if !a.include?("http")
  ...
  source = URI.encode(a)
  @y =  DQReadability::Document.new(source,:tags=>%w[div pre p h1 h2 h3 h4 td table tr b a img br li ul ol center br hr blockquote em strong],:attributes=>%w[href src align width  color]).content
  begin
